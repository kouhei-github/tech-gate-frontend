    ...
    <div class="w-[730px] mx-auto my-4">
        ...
        <div class="flex items-start justify-center space-x-10 my-10">
          ...
          <div>
              ...
              <input placeholder="表示名を入力" type="text" class="border w-full border-[#E5E7EB] py-1 px-2 rounded" />
              <div class="mt-7">
                <label class="text-[#727476] text-[13px]">自己紹介</label>
                <textarea placeholder="自己紹介を入力" rows="3" cols="50" class="border w-full border-[#E5E7EB] py-[4px] px-[8px] rounded mt-1" />
              </div> 
              ...
              <div class="flex items-center justify-center mt-7 w-full space-x-2 mb-7">
                <div class="w-[50%] mx-auto">
                  ...
                  <input placeholder="ユーザー名のみを入力" type="text" class="mt-1 border w-full border-[#E5E7EB] py-1 px-2 rounded" />
                </div>
                <div class="w-[50%] mx-auto">
                  <div class="flex items-center space-x-3">
                  ...
                  <input placeholder="@なしで入力" type="text" class="mt-1 border w-full border-[#E5E7EB] py-1 px-2 rounded" />
                </div>
              </div>
              <div class="w-max mx-auto px-6 py-2 text-white bg-[#228BE6] cursor-pointer hover:bg-blue-600 font-bold rounded-full">更新する</div>
          </div>
