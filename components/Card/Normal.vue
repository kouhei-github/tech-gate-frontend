      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center justify-center space-x-2 z-20" @click.stop="mark(props.recommendImage.id)">
          <div class="flex items-center justify-center"  @click.stop="mark(props.recommendImage.id)">
              <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 hover:bg-white" :class="{'text-[#3595E8] fill-[#3595E8]': recommendImage.now_bookmarked, 'text-[#B6BBC0]' : !recommendImage.now_bookmarked}" width="18" height="18" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M9 4h6a2 2 0 0 1 2 2v14l-5 -3l-5 3v-14a2 2 0 0 1 2 -2"></path></svg>
              <span class="ml-1" :class="{'text-[#3595E8]': recommendImage.now_bookmarked, 'text-[#B6BBC0]' : !recommendImage.now_bookmarked}">{{recommendImage.book_marked_num}}</span>
          </div>
          ...
          <div class="flex items-center justify-center" @click.stop="good(props.recommendImage.id)">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 hover:bg-white" :class="{'text-[#3595E8] fill-[#3595E8]': recommendImage.now_liked, 'text-[#B6BBC0]' : !recommendImage.now_liked}" width="18" height="18" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M7 11v8a1 1 0 0 1 -1 1h-2a1 1 0 0 1 -1 -1v-7a1 1 0 0 1 1 -1h3a4 4 0 0 0 4 -4v-1a2 2 0 0 1 4 0v5h3a2 2 0 0 1 2 2l-1 5a2 3 0 0 1 -2 2h-7a3 3 0 0 1 -3 -3"></path></svg>
            <span class="ml-1" :class="{'text-[#3595E8]': recommendImage.now_liked, 'text-[#B6BBC0]' : !recommendImage.now_liked}">{{recommendImage.good_num}}</span>
          </div>
