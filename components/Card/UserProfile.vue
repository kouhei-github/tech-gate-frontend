...
<template>
    <div class="relative">
        ...
        <div v-if="toggleOpen" class="absolute -right-[150%] bg-white w-[200px] h-[353px] border">
            <p class="w-11/12 mx-auto text-[#8E969D] py-4 my-1 text-[12px] bg-[rgb(241,243,245)]">
            ...
            <div class="w-10/12 mx-auto">
              <div class="text-[#515151] text-[14px] space-y-4 border-y py-2">
                  <div class="flex items-center justify-start space-x-1 cursor-pointer cursor-pointer">
